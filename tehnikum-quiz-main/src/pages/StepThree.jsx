...
export const StepThree = () => {
  const answers = [
    { label: 'Ваш ответ 1', img: 'laugh.png' },
    { label: 'Ваш ответ 2', img: 'hearts.png' },
    { label: 'Ваш ответ 3', img: 'smirk.png' },
    { label: 'Ваш ответ 4', img: 'fright.png' }
  ]; // Массив вынесен
